...
import purlin.utils.{GlobalRouting, MeshSBModel, Parameters, SBModel}
import purlin.utils.SimpleDualPortSram
 ...
 * @param configSize  the width of the configuration of each mux
 * @param w           the width
 */
...
/** A flexible switch box module generated by a circuit-switched router model.
 *
 * @param model   the circuit-switched router model
 * @param w       the width
 * @param regNext indicate whether there should be a register at each output port
 */
...
/** A network module based on flexible switch boxes generated by a circuit-switched on-chip network model.
 *
 * @param model the circuit-switched on-chip network model
 * @param w     the width
 */
...
/** A network module with a configuration memory.
 *
 * @param model        the circuit-switched on-chip network model
 * @param w            the width
 * @param contextDepth the depth of configuration memory
 */
